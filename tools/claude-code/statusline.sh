...
# Layout: [model] [cwd] [git branch] [context %]
...
ICON_GIT=$(printf '\xee\x82\xa0')     # U+E0A0 nf-pl-branch
...
# Branch name, or short SHA when detached; empty outside a work tree
